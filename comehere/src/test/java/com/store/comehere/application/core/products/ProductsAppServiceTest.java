...
import com.store.comehere.domain.core.products.*;
...
public class ProductsAppServiceTest {
	...
	public void searchKeyValuePair_PropertyExists_ReturnBooleanBuilder() {
        ...
        map.put("category",searchFields);
		Map<String,String> searchMap = new HashMap<>();
        searchMap.put("xyz",String.valueOf(ID));
		BooleanBuilder builder = new BooleanBuilder();
        builder.and(products.category.eq("xyz"));
	...
	public void search_SearchIsNotNullAndSearchContainsCaseThree_ReturnBooleanBuilder() throws Exception {
        ...
        fields.setFieldName("category");
        fields.setOperator("equals");
		fields.setSearchValue("xyz");
        fieldsList.add(fields);
        search.setFields(fieldsList);
		BooleanBuilder builder = new BooleanBuilder();
        builder.or(products.category.eq("xyz"));
