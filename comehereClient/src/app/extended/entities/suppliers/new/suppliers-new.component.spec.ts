...
describe('SuppliersNewExtendedComponent', () => {
  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [SuppliersNewExtendedComponent, NewComponent, FieldsComp],
        imports: [TestingModule],
        providers: [SuppliersExtendedService, { provide: MAT_DIALOG_DATA, useValue: {} }],
  ...
  describe('Integration tests', () => {
    describe('', () => {
      beforeEach(async(() => {
        TestBed.configureTestingModule({
          declarations: [SuppliersNewExtendedComponent, NewComponent, FieldsComp].concat(EntryComponents),
          imports: [TestingModule],
          providers: [SuppliersExtendedService, { provide: MAT_DIALOG_DATA, useValue: {} }],
        });
      }));
