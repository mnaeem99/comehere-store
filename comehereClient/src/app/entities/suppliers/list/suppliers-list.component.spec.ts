  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [SuppliersListComponent, ListComponent],
        imports: [TestingModule],
        providers: [SuppliersService, ChangeDetectorRef],
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/suppliers/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
