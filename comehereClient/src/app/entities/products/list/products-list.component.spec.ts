...
import { IProducts, ProductsService, ProductsDetailsComponent, ProductsListComponent, ProductsNewComponent } from '../';
  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [ProductsListComponent, ListComponent],
        imports: [TestingModule],
        providers: [ProductsService, ChangeDetectorRef],
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/products/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
