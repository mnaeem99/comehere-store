  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [OrderItemsListComponent, ListComponent],
        imports: [TestingModule],
        providers: [OrderItemsService, ChangeDetectorRef],
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/orderitems/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
