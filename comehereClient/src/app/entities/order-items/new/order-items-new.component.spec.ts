  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [OrderItemsNewComponent, NewComponent, FieldsComp],
        imports: [TestingModule],
        providers: [OrderItemsService, { provide: MAT_DIALOG_DATA, useValue: {} }],
  ...
  describe('Integration tests', () => {
    ...
    describe('', () => {
      it('should set the passed data to form', async () => {
        TestBed.configureTestingModule({
          declarations: [OrderItemsNewComponent, NewComponent, FieldsComp].concat(EntryComponents),
          imports: [TestingModule],
          providers: [OrderItemsService, { provide: MAT_DIALOG_DATA, useValue: relationData }],
        });
