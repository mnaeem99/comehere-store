  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [CustomersListComponent, ListComponent],
        imports: [TestingModule],
        providers: [CustomersService, ChangeDetectorRef],
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/customers/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
