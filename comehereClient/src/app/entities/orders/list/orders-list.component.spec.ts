...
import { IOrders, OrdersService, OrdersDetailsComponent, OrdersListComponent, OrdersNewComponent } from '../';
  ...
  let constData: IOrders[] = [
    {
      ...
      total: 1,
      customerId: 1,
      customersDescriptiveField: 'email1',
    },
    {
      orderDate: d,
      orderId: 2,
      ...
      total: 2,
      customerId: 2,
      customersDescriptiveField: 'email2',
    },
  ];
  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [OrdersListComponent, ListComponent],
        imports: [TestingModule],
        providers: [OrdersService, ChangeDetectorRef],
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/orders/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
